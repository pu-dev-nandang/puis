...
class M_master_kelompok_profesi_model extends CI_Model {

    function __construct() {
       parent::__construct();
       $this->columns = isset($this->subdata['table_default']) ? $this->subdata['table_default']['columns'] : [];
       // $this->sqlFrom = '
    ...
    function get_all($start = 0, $length, $filter = array(), $order = array()) {
        ...
        return $this->db->get($this->subdata['tabledb']);
    }
    ...
    public function get_total($filter = array()){
        ...
        $data = $this->db->count_all_results($this->subdata['tabledb']);
        return $data;
    }
