...
<div class="tabbable tabbable-custom tabbable-full-width btn-read menu">
    <ul class="nav nav-tabs">
        ...
        <li class="<?php echo ($this->uri->segment(4) == 'create_spb') ? 'active' : '' ?>">
            <a href="<?php echo base_url().'budgeting_menu/pembayaran/spb/create_spb'?>">Create SPB</a>
        </li>
    </ul>
        ...
        <div class="col-xs-12" >
            <div class="panel panel-primary" style="min-width: 800px;overflow: auto;">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title pull-left" style="padding-top: 7.5px;">SPB</h4>
                </div>
