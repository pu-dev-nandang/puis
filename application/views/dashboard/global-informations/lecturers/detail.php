			...
			<div class="panel panel-default" id="biodata">
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-sm-5">
							<div class="profile-info">
                                <h3><?=$detail->DivisionMain?></h3>
                                <h3><?=$detail->ProdiNameEng?></h3>
                                <h3>Join Date 
			...
			<div class="row" id="independent-box">
				...
				<div class="col-sm-6">
					<div class="panel panel-default">
						<div class="panel-body">
							<div class="box-heading">
								<h4><i class="fa fa-bookmark"></i> Lecturer Detail</h4>
							</div>
							<div class="row">
								<div class="col-sm-12">
									<div class="box-ctn academic">										
										<div class="content">
											...
											<div class="row">
												...
												<p class="col-sm-9"><?=(!empty($detail->NIDN) ? $detail->NIDN : '-')?></p>
											</div>
											<div class="row">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("body #detail-user .go-back").click(function(){
			$("#lecturer-list").removeClass("hidden");
