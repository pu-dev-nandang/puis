    ...
    <form class="form-horizontal" id="formModal">
        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                   <input type="text" name="Discount" id= "Discount" placeholder="Input Discount" class="form-control">
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        <?php if ($action == 'edit'): ?>
         $("#Discount").val("<?php echo $getData[0]['Discount'] ?>");
        <?php endif ?>
        $('#Discount').maskMoney({thousands:'.', decimal:',', precision:1,allowZero: true});
    });
</script>