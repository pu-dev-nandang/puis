	    ...
	    else
	    {
	    	...
	    	$("#divTableData").append(
	    		'<div class="col-xs-12" align = "right">'+
	   				'<button class="btn btn-primary btn-Save" id="btn-Save">Approve</button>&nbsp'+
	   				'<button class="btn btn-warning btn-notification btn-reject" id="btn-reject">Reject</button>'+
				'</div>'
	    		);
	    	callback();
	    }
