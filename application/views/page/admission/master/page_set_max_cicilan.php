...
<script type="text/javascript">
   ...
   function modal_generate(action,title,ID='') {
       var url = base_url_js+"admission/master/modalform_set_max_cicilan";
       var data = {
           Action : action,
           CDID : ID,
       };
   ...
   $(document).on('click','#ModalbtnSaveForm', function () {
       ...
       var url = base_url_js+'admission/master/modalform_set_max_cicilan/save';
       var max_cicilan = $("#max_cicilan").val().trim();
   ...
   function loadData()
   {
       var url = base_url_js+'admission/master/data_cfg_cicilan';
