...
<script type="text/javascript">
  ...
  $(document).on('click','.btn-add', function () {
     modal_generate('add','Add Jurusan Sekolah');
  });

  $(document).on('click','.btn-edit', function () {
    var ID = $(this).attr('data-smt');
     modal_generate('edit','Edit Jurusan Sekolah',ID);
  });
  ...
  $(document).on('click','#confirmYesDelete',function () {
        ...
        var url = base_url_js+'admission/master-config/submit_jurusan_sekolah';
        var aksi = "delete";
        var ID = $(this).attr('data-smt');
        var data = {
            Action : aksi,
  ...
  function modal_generate(action,title,ID='') {
      var url = base_url_js+"admission/master-config/modalform/register_major_school";
      var data = {
          Action : action,
          CDID : ID,
      };
  ...
  function loadTable()
  {
    ...
    var url = base_url_js+'admission/master-config/loadTableMaster/register_major_school';
