...
<script type="text/javascript">
  ...
  $(document).on('click','#confirmYesDelete',function () {
        ...
        var url = base_url_js+'admission/master-config/submit_harga_formulir_offline';
        var aksi = "delete";
        var ID = $(this).attr('data-smt');
        var data = {
            Action : aksi,
  ...
  function modal_generate(action,title,ID='') {
      var url = base_url_js+"admission/master-config/modalform/price_formulir_offline";
      var data = {
          Action : action,
          CDID : ID,
      };
  ...
  function loadTable()
  {
    ...
    var url = base_url_js+'admission/master-config/loadTableMaster/price_formulir_offline';
