    ...
    <div class="col-md-8">
        <div class="widget box">
            <div class="widget-header">
                <h4 class="header"><i class="icon-reorder"></i>Jenis Pendapatan</h4>
                <div class="toolbar no-padding">
                    <div class="btn-group">
                      <span data-smt="" class="btn btn-xs btn-add">
                        <i class="icon-plus"></i> Add Jenis Pendapatan
                       </span>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
  ...
  $(document).on('click','.btn-add', function () {
     modal_generate('add','Add Jenis Pendapatan');
  });

  $(document).on('click','.btn-edit', function () {
    var ID = $(this).attr('data-smt');
     modal_generate('edit','Edit Jenis Pendapatan',ID);
  });
  ...
  $(document).on('click','#confirmYesDelete',function () {
        ...
        var url = base_url_js+'admission/master-config/submit_Pendapatan';
        var aksi = "delete";
        var ID = $(this).attr('data-smt');
        var data = {
            Action : aksi,
  ...
  function modal_generate(action,title,ID='') {
      var url = base_url_js+"admission/master-config/modalform/register_income_m";
      var data = {
          Action : action,
          CDID : ID,
      };
  ...
  function loadTable()
  {
    ...
    var url = base_url_js+'admission/master-config/loadTableMaster/register_income_m';
