...
<script type="text/javascript">
  ...
  $(document).on('click','#confirmYesDelete',function () {
        ...
        var url = base_url_js+'admission/master-registration/submit_jpau';
        var aksi = "delete";
        var ID = $(this).attr('data-smt');
        var data = {
            Action : aksi,
  ...
  function modal_generate(action,title,ID='') {
      var url = base_url_js+"admission/master-registration/modalform_jpau";
      var data = {
          Action : action,
          CDID : ID,
      };
  ...
  function loadData()
  {
      var url = base_url_js+'admission/master-registration/jpau/table_jpau';
