            ...
            <li class="<?php if($this->uri->segment(2)=='config'){echo "current open";} ?>">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="<?php if($this->uri->segment(2)=='config' && $this->uri->segment(3) == 'sdaerah' ){echo "open-default";} ?>">
                        ...
                        <ul class="sub-menu">
                            <li class="<?php if($this->uri->segment(2)=='config' && $this->uri->segment(3) == "sdaerah" && $this->uri->segment(4) == "master-sma"){echo "current";} ?>">
                                <a href="<?php echo base_url('admission/config/sdaerah/master-sma'); ?>">
                                <i class="icon-angle-right"></i>
                                SMA / SMK
                                </a>
                            </li>
                            <li class="<?php if($this->uri->segment(2)=='config' && $this->uri->segment(3) == "asekolah"){echo "current";} ?>">
                                <a href="<?php echo base_url('admission/config/asekolah'); ?>">
                                <i class="icon-angle-right"></i>
                                Approve Sekolah
                                </a>
                            </li>
