...
function loadTable()
{
	...
	$.post(url,function (resultJson) {
	    ...
	    for (var i = 0; i < dataForTable.length; i++) {
	    	var btn_edit = '<button type="button" class="btn btn-warning btn-edit btn-edit-time btn-write" Year = "'+dataForTable[i].Year+'"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button>';
	    	var btn_del = '<button type="button" class="btn btn-danger btn-deleteTime btn-write"  Year = "'+dataForTable[i].Year+'"> <i class="fa fa-trash" aria-hidden="true"></i> </button>';
