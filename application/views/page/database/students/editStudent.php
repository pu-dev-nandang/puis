        ...
        <div class="">
            <div class="panel-body" style="min-height: 100px;">
                ...
                <div style="text-align: left;">
                    <h1 style="margin-bottom: 20px;margin-top: 0px"><i class="fa fa-user margin-right"></i> Personal Identity</h1>
                </div>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <td colspan="3">
                                    <select class="form-control ins-InsuranceID" name="InsuranceID" disabled>
                                        <option value="">Choose One</option>
                                    ...
                                    <div class="oth-cp-name hidden">
                                        ...
                                        <input type="text" name="InsuranceOTH" class="form-control ins-InsuranceOTH" placeholder="Company Name" disabled >
                                        </div>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <input type="text" name="InsurancePolicy" class="form-control ins-InsurancePolicy" disabled >
                                    <span class="message-error"></span>
                                </td>
                            </tr>
                            <tr>
...
<script>
                ...
                $.each(resultInsurance, function(key,value){
                    ...
                    if($.trim(key) == 'InsuranceID'){
                        ...
                        if($.trim(value) == 0){
                           ...
                           $("#health-insurance").find("select[name=InsuranceID]").hide();
                        }*/
                    }
                });
    ...
    function fetchInsuranceStd(NPM) {
        ...
        $.ajax({
            type : 'POST',
            url : base_url_portal_students+"profile/insurance",
            data: {token:token},
            dataType : 'json',
            async: false,
            cache: false,
