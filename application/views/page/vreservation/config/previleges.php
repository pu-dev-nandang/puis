...
<script type="text/javascript">
  ...
  $(document).on('change','.grouPAuth', function () {
      ...
      var valuee = $(this).val();
      var url =base_url_js+'vreservation/edit_auth_user';
    ...
    $(document).on('click','#btn-save', function () {
        ...
        {
            var url =base_url_js+'vreservation/add_auth_user';
    ...
    $(document).on('click','.btn-delete-group', function () {
      ...
      $("#confirmYes").click(function(){
          ...
          var url =base_url_js+'vreservation/delete_authUser';
          var data = {NIP : NIP};
          var token = jwt_encode(data,'UAP)(*');
          $.post(url,{token:token},function (data_json) {
            loadGroupUser(loadDataGroupUser);
    ...
    function loadDataGroupUser()
    {
        ...
        var dataTable = $('#IDTblGroupUser').DataTable( {
            ...
            "ordering" : false,
            "ajax":{
                url : base_url_js+"vreservation/config/getAuthDataTables", // json datasource
                ordering : false,
