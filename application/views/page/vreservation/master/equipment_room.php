    ...
    <div class="col-md-12">
        <div class="widget box">
            <div class="widget-header">
                <h4 class="header"><i class="icon-reorder"></i>Set Equipment Room</h4>
...
<script type="text/javascript">
   ...
   $(document).on('click','.btn-add', function () {
      modal_generate('add','Add Equipment Room');
   });

   function modal_generate(action,title,ID='') {
       var url = base_url_js+"vreservation/master/modal_form_equipmentroom";
       var data = {
           Action : action,
           CDID : ID,
       };
   ...
   $(document).on('click','#ModalbtnSaveForm', function () {
       ...
       var url = base_url_js+'vreservation/master/EquipmentRoom/submit';
       var selectRoom = $("#selectRoom").val().trim();
   ...
   function loadData()
   {
       var url = base_url_js+'vreservation/master/loaddataJSonEquipmentRoom';
