    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div id="viewTable" class="table-responsive">
                <table class="table dataTable2Excel" data-name="Pkm-melibatkan-mhs" id="dataTablesPMM">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama Dosen</th>
...
var oTable;
var oSettings; 
var App_pkm_melibatkan_mhs = {
    LoadAjaxTable : function(){
         var recordTable = $('#dataTablesPMM').DataTable({
             "processing": true,
             "serverSide": false,
             "ajax":{
                 url : base_url_js+"rest3/__get_APS_CrudAgregatorTB7_", // json datasource
                 ordering : false,
    ...
    loaded : function(){
        var firstLoad = setInterval(function () {
            ...
            if(filterProdi!='' && filterProdi!=null){
                ...
                App_pkm_melibatkan_mhs.LoadAjaxTable();
