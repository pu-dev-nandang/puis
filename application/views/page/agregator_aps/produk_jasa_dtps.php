...
var App_produk_jasa_dtps = {
    ...
    LoadAjaxTable : function(){
         var recordTable = $('#dataTablesPJD').DataTable({
             ...
             "serverSide": false,
             "ajax":{
                 url : base_url_js+"rest3/__get_APS_CrudAgregatorTB3", // json datasource
                 ordering : false,
    ...
    loaded : function(){
        ...
        var firstLoad = setInterval(function () {
            ...
            if(filterProdi!='' && filterProdi!=null && FilterTahun !='' && FilterTahun!=null){
                ...
                App_produk_jasa_dtps.LoadAjaxTable();
