	...
	<div class="row">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">
						<i class="fa fa-edit"></i> Form Master Status
					</h4>
				</div>
				<div class="panel-body">
					<form id="form-master" action="<?=site_url('human-resources/master-aphris/saveStatus')?>" method="post" autocomplete="off">
		...
		<div class="col-sm-9">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">
						<i class="fa fa-bars"></i> <span>List of Master Status</span>
					</h4>
				</div>
				<div class="panel-body">
					<div class="list">
...
<script type="text/javascript">
	function fetchingData() {
        ...
        var dataTable = $('#master-aphris #table-list-data').DataTable( {
            ...
            "ajax":{
                url : base_url_js+'human-resources/master-aphris/fetchStatus', // json datasource
                ordering : false,
            ...
            "columns": [
	            ...
	            },
	            {
	                ...
	                "render": function (data, type, row) {
	            		return "<p>"+data+"</p>"+((row.description.length > 0) ? "<p>"+row.description+"</p>" : '');
	            	}
	            },
	            { 
	            	"data": "IsActive",
	...
	$(document).ready(function(){
		...
		$("#table-list-data").on("click","tbody .btn-edit",function(){
			...
			var data = {
          	...
          	$.ajax({
			    type : 'POST',
			    url : base_url_js+"human-resources/master-aphris/detailStatus",
			    data : {token:token},
			    dataType : 'json',
