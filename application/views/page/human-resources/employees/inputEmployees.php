        ...
        <div class="col-sm-12">
            <div class="tabulasi-emp">
              <ul class="nav nav-tabs" role="tablist">
                <li class="active"><a href="<?=site_url('human-resources/employees/input-employees')?>">Personal Data</a></li>
                <li><a class="tab-addtional-info cursor-disable">Additional Information</a></li>
              </ul>
            </div>
        </div>
    </div>
