    ...
    <div class="col-md-12">
        ...
        <div class="tabbable tabbable-custom tabbable-full-width">
            <ul class="nav nav-tabs">
                <li class="active"><a href="javascript:void(0)" class="menuDetails" data-page="academic_details" data-toggle="tab">Biodata</a></li>
                <li class=""><a href="javascript:void(0)" class="menuDetails" data-page="academic_sratasatu" data-toggle="tab">Academic S1</a></li>
                <li class=""><a href="javascript:void(0)" class="menuDetails" data-page="academic_sratadua" data-toggle="tab">Academic S2</a></li>
                <li class=""><a href="javascript:void(0)" class="menuDetails" data-page="academic_sratatiga" data-toggle="tab">Academic S3</a></li>
                <li class=""><a href="javascript:void(0)" class="menuDetails" data-page="otherfiles" data-toggle="tab">Other Files</a></li>
