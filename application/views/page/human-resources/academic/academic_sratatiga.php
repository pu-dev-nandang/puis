        ...
        $.post(url,{token:token},function (resultJson) {
            ...
            if(response.length > 0){
                ...
                for (var i = 0; i < response.length; i++) {
                    ...
                    '            <td style="text-align: center;"><button class="btn btn-sm btn-primary btn-circle testdetail" data-toggle="tooltip" data-placement="top" title="Edit" nameuniv= "'+response[i]['NameUniversity']+'" fileijazahs3 ="'+listdatas1+'" filetranscripts3 ="'+listdatas2+'"><i class="icon-list icon-large"></i></button> <button id="btnedits1" class="btn btn-sm btn-primary btn-circle testEdit3" data-toggle="tooltip" data-placement="top" title="Edit" nameuniv= "'+response[i]['NameUniversity']+'" fileijazahs1 ="'+listdatas1+'" filetranscripts1 ="'+listdatas2+'"><i class="fa fa-edit"></i></button> <button class="btn btn-danger btn-circle btndelist" data-toggle="tooltip" data-placement="top" title="Delete" listid1 ="'+iddata1+'" listid2 ="'+iddata2+'"><i class="fa fa-trash"></i></button></td>      '+     
                    '         </tr> ');
                }
...
<script>
 ...
 <script>
    $(document).on('click','.testdetail',function () {
        var NIP = '<?php echo $NIP; ?>';
        var acad = 'S3';
        var fileijazahs2 = $(this).attr('fileijazahs3');
        var filetranscripts2 = $(this).attr('filetranscripts3');
        var nameuniv = $(this).attr('nameuniv');
