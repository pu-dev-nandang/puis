...
class C_ba extends Budgeting_Controler { // SPB / Bank Advance 
            ...
            if ($__checkdt) {
                ...
                switch ($action) {
                    case 'add':
                        ...
                        $__ChkRealisasi = $this->m_global->__ChkRealisasi($Input['Departement'],'Bank Advance');
                        if ($__ChkRealisasi) {
                           $this->insert_ba();
                           $rs['Status']= 1;
                        }
                        ...
                        {
                            $rs['Status']= 0;
                            $rs['msg']= 'Bank Advance sebelumnya belum selesai, tidak bisa create';
                        }
                        break;
                    case 'edit':
    ...
    public function PaymentToIssued_user()
    {
        ...
        $__ChkRealisasi = $this->m_global->__ChkRealisasi($Departement,'Bank Advance');
        if ($__ChkRealisasi) {
        ...
        {
            $St_error= 0;
            $msg= 'Bank Advance sebelumnya belum selesai, tidak bisa create';
        }
                ...
                for ($i=0; $i < count($FormInsertDetail); $i++) { 
                 ...
                 // Send Notif for next approval
                     $data = array(
                         'auth' => 's3Cr3T-G4N',
                         'Logging' => array(
                                         'Title' => '<i class="fa fa-check-circle margin-right" style="color:green;"></i>  Created Realisasi '.'Bank Advance'.' of '.$CodeDept,
