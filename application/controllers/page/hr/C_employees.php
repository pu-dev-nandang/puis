...
class C_employees extends HR_Controler
{
    ...
    public function edit_employees($NIP)
    {
        ...
        // get sub_prodi
        $data['dataSubProdi'] = $this->m_hr->getSubProdi($NIP);
                ...
                if ($data_arr['ACT'] == 2) { //for rejected
                    ...
                    if (!empty($isExist->Logs)) {
                        ...
                        if (!empty($Logs->MyEducation)) {
                            $MyEducation = $Logs->MyEducation;
                            unset($Logs->MyEducation);
                        ...
                        if (!empty($Logs->MyEducationNonFormal)) {
                            $MyEducationNonFormal = $Logs->MyEducationNonFormal;
                            unset($Logs->MyEducationNonFormal);
                        ...
                        if (!empty($Logs->MyEducationTraining)) {
                            $MyEducationTraining = $Logs->MyEducationTraining;
                            unset($Logs->MyEducationTraining);
                        ...
                        if (!empty($Logs->MyExperience)) {
                            $MyExperience = $Logs->MyExperience;
                            unset($Logs->MyExperience);
                    ...
                    $message = "Unknow request approved.";
                }
            } else {
                $message = "Student data is not founded.";
            }
    ...
    public function familySave()
    {
        ...
        if ($data) {
            if (!empty($data['relation'])) {
                ...
                $message = "Cannot saved. Empty data post.";
            }
    ...
    public function careerSave()
    {
        ...
        if ($data) {
            ...
            if (!empty($data['JoinDate'])) {
                for ($h = 0; $h < count($data['JoinDate']); $h++) {
                    ...
                    if (!empty($data['joinID'][$h])) {
                        ...
                        if (!empty($isExist)) {
                            ...
                            $message = "Historical join not founded.";
                        }
                    } else {
                ...
                $message .= "Cannot saved. Empty dataPost";
            }
        ...
        if ($data) {
            ...
            if ($action == "BPJS") {
                if (!empty($data['CardNumber'])) {
                    ...
                    for ($i = 0; $i < count($data['CardNumber']); $i++) {
                        if (!empty($data['CardNumber'][$i]) && !empty($data['NIP'])) {
                            ...
                            if ($isvalid) {
                                ...
                                $message = "Card Number [" . $data['CardNumber'][$i] . "] is not exist.";
                            }
                        } else {
                    ...
                    $message = "There's no post data on BPJS.";
                }
                ...
                if (!empty($data['Allowance'])) {
                    ...
                    $message = "There's no post data on Allowance.";
                }
            }
