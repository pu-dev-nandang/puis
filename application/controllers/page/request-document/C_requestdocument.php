...
class C_requestdocument extends Globalclass {
    ...
    public function menu_request($page){
        $data['page'] = $page;
        $content = $this->load->view('page/secretariat-rectorate/menu_sec-rektorat2',$data,true);
        $this->temp($content);
    }
    ...
    public function list_academic_employee() 
    {
        $page = $this->load->view('page/'.$this->data['department'].'/list_academic_otherfiles','',true);
        $this->menu_request($page);
