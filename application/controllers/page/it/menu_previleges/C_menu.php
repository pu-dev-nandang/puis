...
class C_menu extends It_Controler {
    ...
    public function __construct()
    {
        ...
        if (!$this->session->userdata('db_select')) {
           $this->session->set_userdata('db_select','db_it');
        }
    ...
    public function menu_request($page){
        $data['page'] = $page;
        $content = $this->load->view('page/it/menu_previleges/menu_choose',$data,true);
        $this->temp($content);
    }
    ...
    public function menu()
    {
    	...
    	$content = $this->load->view('page/it/menu_previleges/menu',$this->data,true);
    ...
    public function sub_menu()
    {
		...
		$content = $this->load->view('page/it/menu_previleges/sub_menu',$this->data,true);
        $this->menu_request($content);
    }
    ...
    {
    	$content = $this->load->view('page/it/menu_previleges/group_user',$this->data,true);
    	$this->menu_request($content);
    }
