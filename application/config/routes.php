...
// print_r(test github push 2);die();
...
$route['save2pdf/print_akses_karyawan'] =  'C_save_to_pdf3/print_akses_karyawan';
// ---- Save to EXCEL
...
$route['api/database/__fetchStudents'] = 'api/c_api/fetchStudentsObj';
$route['api/database/__fetchEmployees'] = 'api/c_api/fetchEmployeeObj';
...
$route['it/console-developer/routes/submit'] = 'page/it/c_it/submit_routes';
